...
print("Elapsed Time 1 worker, 400k total work: "+one_worker)
print("Elapsed Time 4 workers, 400k total work: "+four_workers)
print("Elapsed Time 12 workers, 400k total work: "+twelve_workers)